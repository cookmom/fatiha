...
async function main(){
  ...
  await page.evaluate(()=>{window._forceTimeMin=1300;window._forceLocation={lat:21.4225,lon:39.8262,name:'Makkah'};});
  ...
  await page.evaluate(async()=>{
    ...
    if(pill){pill.style.display='flex';pill.style.zIndex='999';pill.style.opacity='1';pill.style.pointerEvents='auto';pill.style.setProperty('display','flex','important');pill.style.setProperty('opacity','1','important');}
  ...
  await page.screenshot({path:'/home/openclaw-agent/.openclaw/workspace/test-pill-final.png',type:'png'});
  console.log('Done');
