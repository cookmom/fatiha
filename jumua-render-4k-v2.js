...
const FRAMES = 450;
const FRAME_DIR = '/tmp/jumua-frames-4k-v2';
...
(async () => {
  ...
  // Original phone viewport at DPR 5 = 2150×4660, will crop to 2160×3840 in ffmpeg
  await p.setViewport({ width: 430, height: 932, deviceScaleFactor: 5 });
  ...
  console.log('Starting 4K frame capture (2150x4660 raw, will crop)...');
  for (let i = 0; i < FRAMES; i++) {
    await p.evaluate((ms) => { window._fakeMs += ms; }, MS_PER_FRAME);
