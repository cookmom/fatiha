...
const FRAMES = 450;
const FRAME_DIR = '/tmp/jumua-frames-4k';
...
(async () => {
  ...
  // 4K: 720×1280 @ DPR 3 = 2160×3840
  await p.setViewport({ width: 720, height: 1280, deviceScaleFactor: 3 });
  ...
  console.log('Starting 4K frame capture (2160x3840)...');
