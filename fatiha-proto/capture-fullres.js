...
const OUT_DIR = path.join(__dirname, 'captures-fullres');
...
const server = http.createServer((req, res) => {
  ...
  fs.readFile(filePath, (err, data) => {
    ...
    if (req.url === '/') {
      ...
      // Keep full 1080x1920 resolution
      // Remove frameRate limit for max speed
      html = html.replace('frameRate(30);', 'frameRate(999);');
      // DISABLE fillBleed to avoid SwiftShader OOM
