...
async function main(){
  ...
  await page.evaluate(async()=>{
    ...
    if(pill){
      ...
      pill.style.bottom='10%'; // move up from 8% to 35%
    }
    ...
    if(ml){
      ...
      ml.style.bottom='calc(10% + 62px)'; // just above pill
    }
    ...
    guide.style.cssText='position:fixed;top:9%;left:0;width:100%;height:0;border-top:1px dashed rgba(255,0,0,0.4);z-index:10000;pointer-events:none';
    document.body.appendChild(guide);
    const guide2=document.createElement('div');guide2.className='poster-overlay';
    guide2.style.cssText='position:fixed;top:91%;left:0;width:100%;height:0;border-top:1px dashed rgba(255,0,0,0.4);z-index:10000;pointer-events:none';
