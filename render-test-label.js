...
const SITE_DIR='/home/tawfeeq/ramadan-clock-site',PORT=9931;
...
async function main(){
  ...
  await page.evaluateOnNewDocument(()=>{Date.prototype.getSeconds=function(){return 0};Date.prototype.getMilliseconds=function(){return 0};window._forceTimeMin=1300;window._forceLocation={lat:21.4225,lon:39.8262,name:'Makkah'}});
  ...
  await page.screenshot({path:'/home/openclaw-agent/.openclaw/workspace/test-real-label.png',type:'png'});
  console.log('Done');
