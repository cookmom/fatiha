...
const OUT = path.join(__dirname, 'night-frames');
const FRAMES = 600;
const OUTPUT_MP4 = path.join(__dirname, 'agot-timelapse-night-v2.mp4');
...
const WIREFRAME_CUBE_SVG = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="48" height="48">
  <g stroke="rgba(255,255,255,0.6)" stroke-width="1.2" fill="none">
    <!-- Front face -->
    <polygon points="25,35 65,25 65,75 25,85"/>
    <!-- Back face -->
    <polygon points="35,20 75,10 75,60 35,70"/>
    <!-- Connecting edges -->
    <line x1="25" y1="35" x2="35" y2="20"/>
    <line x1="65" y1="25" x2="75" y2="10"/>
    <line x1="65" y1="75" x2="75" y2="60"/>
    <line x1="25" y1="85" x2="35" y2="70"/>
  </g>
</svg>`;
...
async function run() {
  ...
  await page.evaluate((svgMarkup) => {
    ...
    // Title overlay — picture safe area
    const title = document.createElement('div');
    title.textContent = 'A GIFT OF TIME';
    title.style.cssText = 'position:fixed;top:80px;left:0;right:0;text-align:center;font-family:inherit;font-size:28px;font-weight:200;letter-spacing:8px;color:rgba(255,255,255,0.85);z-index:9999;pointer-events:none;';
    document.body.appendChild(title);

    // Wireframe cube logo — bottom right picture safe
    const logo = document.createElement('div');
    logo.innerHTML = svgMarkup;
    logo.style.cssText = 'position:fixed;bottom:80px;right:60px;z-index:9999;pointer-events:none;opacity:0.7;';
    document.body.appendChild(logo);

    // Lock second hand at 12
    if (typeof window._lockSecondHand !== 'undefined') window._lockSecondHand = true;
  }, WIREFRAME_CUBE_SVG);
